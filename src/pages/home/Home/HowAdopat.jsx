...
export default function HowAdopat() {
  return (
    <section className='flex flex-col-reverse lg:flex-row gap-8 bg-base-200 min-h-screen py-2 lg:py-20'>
      <div className=" w-full">
        <div className="p-6">
          <h2 className="text-3xl lg:text-6xl font-medium text-[#0E2515] leading-10 lg:leading-[80px]">How to Adopt Your New Friend</h2>
        ...
        <div className="grid grid-cols-2 gap-2 lg:gap-12 p-2 lg:p-4">
