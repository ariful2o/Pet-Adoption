...
export default function Subscribe() {
    return (
        <section>
            <div className="flex flex-col-reverse lg:flex-row pt-20 bg-base-200">
                <div className="">
                    <img className='h-full' src={dogs} alt="" />
                </div>
                <div className="bg-[#1C4A2A] p-4 lg:p-16">
                    <h2 className='text-white text-2xl lg:text-5xl leading-10 lg:leading-[72px]'>Subscribe to Our Newsletter for<br />
                    ...
                    <form className='mt-10 flex flex-col lg:flex-row gap-4'>
                        <label className="input input-bordered flex items-center gap-2 border-1 border-white bg-[#1C4A2A] w-full lg:w-4/5">
                            <img src={mail} alt="" />
