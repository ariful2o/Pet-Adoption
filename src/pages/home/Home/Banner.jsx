...
export default function Banner() {
    return (
        <section className='bg-[url("https://themebeyond.com/pre/petco-prev/petco-live/img/bg/counter_bg.jpg")] py-2 lg:py-20'>
            ...
            <div className="p-4 flex flex-col lg:flex-row gap-4 lg:gap-2 justify-evenly items-center">
                <div className="bg-white rounded-lg flex flex-col justify-center items-center gap-4 px-10 py-6 shadow-lg w-full lg:w-auto">
